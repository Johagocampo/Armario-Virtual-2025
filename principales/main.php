    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="mi-menu">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" style="border-bottom: 5px solid #addd; text-decoration: none; color: rgba(255, 255, 255, 0.867);" href="main.php">Inicio</a>
...
<script>
    ...
    function mostrarImagenAleatoria() {
        ...
        var imagenes = [
            "https://images.unsplash.com/photo-1487452066049-a710f7296400?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D",
            "https://bitlysdowssl-aws.com/wp-content/uploads/2022/10/scc-2.jpg",
            "https://wallpapers.com/images/hd/urban-background-vu817dy8f93zlf3h.jpg"
        ];

        var indiceAleatorio = Math.floor(Math.random() * imagenes.length);

        document.getElementById("imagenAleatoria").src = imagenes[indiceAleatorio];
        cambiarTexto(indiceAleatorio);

        var imagenElemento = document.getElementById("imagenAleatoria");
        imagenElemento.onclick = function () {
            window.location.href = hipervinculos[indiceAleatorio];
        };
    }
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <figure>
                    <img id="imagenAleatoria" src="" class="img-fluid" alt="Imagen 2"
                        style="width: 100%; cursor: pointer;">
                    <figcaption>
                        <h2 id="textoCambiado"> Armario Virtual</h2>
                    </figcaption>
                </figure>
            </div>
